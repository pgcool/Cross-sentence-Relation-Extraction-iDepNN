...
_version_ = 1.0
_maintainer_ =
_email_ = pankaj.gupta@siemens.de, pankaj_gupta96@yahoo.com, pankaj.gupta@tum.de
_status_ = PROGRESS

  DATE            STATUS                        DESCRIPTION
07.07.2015    Initial File Creation       Initial File Creation
08.07.2015       Addition                 Data loading SemVal
26.07.2015       Addition                 Data loading  variants
01.08.2015       Addition                 Entity presence, word context and position features
02.08.2015       Addition                 Loading slot filling data, and variants
03.08.2015       Addition                 Word representation 'word2vec' features
06.08.2015       Update                   Position features updated, relative positions


_filename_ = features.py

Description:
    Data loading, entity extraction, word22vec features for SemVal10 and slot filling data set
...
def repalce_currency_symbols_fn(line):
    tmp_line = ''
    for word in line.split():
...
#stoplist = set('a an and the . , - = * + : ; ! " # % & ( ) * + , - . / : ; < = > ? @ [ \\ ] ^ _ ` { | } ~ \' '.split())
#punctuations = '''!()-[]{};:'"\,<>./?@#%^&*_~'''
#stoplist = set('a an and the . , - = * + : ; ! " # % & ( ) * + , - . / : ; < = > ? @ [ \\ ] ^ _ ` { | } ~ \' '.split())
#punctuations = '''!()-[]{};:'"\,<>./?@#%^&*_~'''
